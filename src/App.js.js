...
const appId = typeof __app_id !== 'undefined' ? __app_id : 'hiyarihat-ai-app';
...
`;
  ...
  return (
    <div style={{ maxWidth: "800px", margin: "0 auto", padding: "20px" }}>
      ...
      <header className="flex justify-between items-center mb-8"><h1 className="text-3xl font-bold text-gray-800">ヒヤリハットAI分析</h1><div className="flex items-center space-x-4"><span className="text-sm text-gray-600 hidden sm:block">{user.email}</span><button onClick={handleLogout} className="btn-secondary">ログアウト</button></div></header>
